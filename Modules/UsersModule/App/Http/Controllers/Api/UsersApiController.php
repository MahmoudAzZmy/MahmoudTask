...
class UsersApiController extends \Lynx\Base\Api
{
    protected $entity = Users::class;
    protected $resourcesJson = \Modules\UsersModule\App\resources\UsersApiResource::class;
    protected $policy = \Modules\UsersModule\App\Policies\UsersApiPolicy::class;
    protected $guard = 'api';
    ...
    {
        return new \Modules\UsersModule\App\resources\UsersApiResource($entity);
    }
